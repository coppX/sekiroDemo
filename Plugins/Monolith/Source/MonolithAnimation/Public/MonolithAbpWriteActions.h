...
private:
	...
	static FMonolithActionResult HandleRenameStateMachine(const TSharedPtr<FJsonObject>& Params);
	static FMonolithActionResult HandleMoveStateMachineToState(const TSharedPtr<FJsonObject>& Params);
};
